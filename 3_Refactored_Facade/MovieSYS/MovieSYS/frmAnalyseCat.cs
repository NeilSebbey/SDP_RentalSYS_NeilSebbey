...
namespace MovieSYS
{
    public partial class frmAnalyseCat : Form
    {
        ...
        private void btnYear_Click(object sender, EventArgs e)
        {
            ...
            string rentDate = currentYear.ToString().Substring(2, 2);
            string category = cboCategory.Text.Substring(0, 2);

            //Call into Rental class from Business Logic
            DataTable dt = Rental.GetCategoryAnalysis(rentDate, category);
